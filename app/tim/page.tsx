...
const teamMembers = [
  {
    ...
    nim: "23XXXXXXXXX",
    role: "Ketua Kelompok",
    speciality: "Project Manager & Koordinator",
    desc: "Bertanggung jawab dalam koordinasi tim dan manajemen proyek secara keseluruhan.",
    color: "cyan",
  },
  {
    name: "Anggota 2",
    ...
    speciality: "Desain & Konfigurasi Jaringan",
    desc: "Merancang topologi jaringan dan konfigurasi perangkat jaringan TI.",
    color: "violet",
  },
  {
    name: "Anggota 3",
    nim: "23XXXXXXXXX",
    role: "Arsitek",
    speciality: "Desain Arsitektur & DWG",
    desc: "Membuat gambar teknis arsitektur dan desain bangunan kantor kecamatan.",
    color: "emerald",
  },
  {
    name: "Anggota 4",
    nim: "23XXXXXXXXX",
    role: "Struktur Engineer",
    speciality: "Perhitungan Struktur",
    desc: "Menghitung dan merancang sistem struktur bangunan termasuk pondasi dan rangka.",
    color: "amber",
  },
  {
    name: "Anggota 5",
    nim: "23XXXXXXXXX",
    role: "Web Developer",
    speciality: "Pengembangan Website",
    desc: "Membangun website portofolio digital interaktif untuk dokumentasi proyek.",
    color: "rose",
  },
  {
    name: "Anggota 6",
    nim: "23XXXXXXXXX",
    role: "Dokumentasi & RAB",
    speciality: "Laporan & Anggaran",
    desc: "Menyusun dokumentasi, laporan, logbook, dan rencana anggaran biaya proyek.",
    color: "blue",
  },
];
